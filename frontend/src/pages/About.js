    ...
    <div className="about-container">
      ...
      <section className="about-content">
        <div className="about-card">
          <h2>🌍 Our Mission</h2>
          <p>
            ImpactSense is designed to empower communities and students with
        ...
        <div className="about-card">
          ...
          <p>
            ...
            ImpactSense integrates modern web development with machine learning
        ...
        <div className="about-card">
          ...
          <p>
            Earthquakes are unpredictable, but awareness saves lives. ImpactSense
